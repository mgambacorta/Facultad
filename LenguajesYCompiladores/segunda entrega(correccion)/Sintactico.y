...
lista_expresiones : lista_expresiones COMA expresion {
						...
						idxToChar( idxExpresion);
						guardarTerceto(auxTer.operando, auxTer.operador1, _auxIdxChar);
					}
				  | expresion {
						_terceto auxTer = desencolar();
						idxToChar( idxExpresion);
...
void encolar( const char* oper, const char* op1, const char* op2 )
{
	...
	strcpy(_colaTercetos[_finCola].operando, oper);
	strcpy(_colaTercetos[_finCola].operador1, op1);
	strcpy(_colaTercetos[_finCola].operador2, op2);
}
...
_terceto desencolar()
{
	...
	strcpy(res.operando, _colaTercetos[_topeCola].operando);
	strcpy(res.operador1, _colaTercetos[_topeCola].operador1);
	strcpy(res.operador2, _colaTercetos[_topeCola].operador2);
