...
public class Dijktra {
	...
	public String printRecorrido(int nodoFinal) {
		...
		return calcularRecorrido(nodoFinal) + nodoFinal;
	}
	
	private String calcularRecorrido(int nodoFinal) {
		String aux = recorrido[nodoFinal] == nodoInicial ? nodoInicial + " --> " : calcularRecorrido(recorrido[nodoFinal]);
		return aux;
	}
